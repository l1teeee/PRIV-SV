...
| 5 | Completar el Registro de Actividades de Tratamiento (RAT) de los tratamientos identificados en el diagnostico | OBL-DOC-02 (Art. 33 inc. 1) | RAT y Mapa de Datos | Delegada de Proteccion de Datos | Dia 0 + 10 dias habiles | RAT con todas las actividades del diagnostico registradas |
