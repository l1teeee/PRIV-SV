...
| Integracion tecnica que descubra automaticamente sistemas y bases de datos de la empresa (escaneo de red o de esquemas) | | | | | Fuera de alcance permanente (no es una fase futura, es un limite de producto): mas cercano a un SIEM que a este producto y contrario al principio de no ejecutar herramientas tecnicas de descubrimiento (ver anti-feature 2) |
