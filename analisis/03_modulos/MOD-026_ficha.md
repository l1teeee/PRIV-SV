...
| MOD-020 Dashboard y Reportes | Que muestra el Dashboard por perspectiva (Gerencia, Responsable, Legal/Delegado, Auditor); Por que este sistema nunca muestra un "porcentaje de cumplimiento legal"; Que son los ocho clusters legales de la vista Legal/Delegado | Catalogo derivado del proposito de `06_mapa_definitivo_de_modulos.md`, seccion 3 (MOD-020_ficha.md existe pero al cierre de esta ficha llega solo hasta la seccion K, sin seccion R todavia; pendiente de confirmar cuando la incorpore) |
...
| MOD-023 Calendario y Motor de Plazos | Como se calculan los dias y las horas habiles; Que son los asuetos nacionales configurables; Por que la fecha de un plazo legal no se puede editar a mano | Catalogo derivado del proposito de `06_mapa_definitivo_de_modulos.md`, seccion 3 (la ficha MOD-023_ficha.md existe pero su seccion R aun no esta redactada al cierre de esta ficha; pendiente de confirmar) |
| MOD-024 Centro Regulatorio | Que significa que una norma este VIGENTE, FUTURO, DEROGADA o MODIFICADA; Que es la bandera de regimen de la reforma 659 (regimen_reforma_659); Que es el Procedimiento Sancionador | Catalogo derivado del proposito de `06_mapa_definitivo_de_modulos.md`, seccion 3 (la ficha MOD-024_ficha.md existe pero su seccion R aun no esta redactada al cierre de esta ficha; pendiente de confirmar) |
